            ...
            <div class="random-product-container__content">
                <div class="item-product">
                    <div class="item-product__title-product">
                        <a href="{{route('game.show', ['game' => $randomGame])}}" class="item-product__title-product__link">{{$randomGame->title}}</a>
                    </div>
                    <div class="item-product__thumbnail"><a href="{{route('game.show', ['game' => $randomGame])}}" class="item-product__thumbnail__link">
                            <img src="{{$randomGame->getImage()}}" alt="Preview-image" class="item-product__thumbnail__link__img"></a></div>
                    <div class="item-product__description">
                        <div class="item-product__description__products-price"><span class="products-price">{{$randomGame->price}} руб</span></div>
                        <div class="item-product__description__btn-block"><a href="{{route('game.show', ['game' => $randomGame])}}" class="btn btn-blue">Купить</a></div>
                    </div>
                </div>
            </div>
        </div>
